...
class Editable extends React.Component {
    ...
    componentDidMount() {
        axios({
            url: 'http://68.183.93.200:3006/home',
            method: 'get',
            headers: {
        ...
        return (<Paper elevation={7} >
            <MaterialTable
                ...
                editable={{
                    ...
                    setTimeout(() => {
                {
                    axios.put(`http://68.183.93.200:3006/home/${oldData._id}/edit`,querystring.stringify({name:newData.name}),{headers: {
                            'Authorization': 'Bearer ' + this.props.token,
                    ...
                    onRowDelete: oldData =>
                        new Promise((resolve, reject) => {
                            setTimeout(() => {
                                {   axios.delete(`http://68.183.93.200:3006/home/${oldData._id}/delete`,{headers: {
                                        'Authorization': 'Bearer ' + this.props.token
                                    }}).then((res) => {
                                        console.log(res);
